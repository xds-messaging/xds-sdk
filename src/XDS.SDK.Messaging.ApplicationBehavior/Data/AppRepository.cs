...
namespace XDS.Messaging.SDK.ApplicationBehavior.Data
{
	public class AppRepository
	{
		...
		public AppRepository(IAsyncRepository<Profile> profiles, IAsyncRepository<Identity> identities, IAsyncRepository<Message> messages, IXDSSecService xdsSecService)
        {
            this.profiles = profiles;
			this.contacts = identities;
