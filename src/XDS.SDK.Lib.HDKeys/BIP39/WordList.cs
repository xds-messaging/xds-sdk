...
namespace XDS.SDK.Lib.HDKeys.BIP39
{
    ...
    {
        static readonly DefaultWordlistSource WordListSource = new DefaultWordlistSource();
		...
		public static Task<WordList> LoadWordList(Language language)
		{
            ...
            return WordListSource.Load(name);
        }
		...
		{
			return new ReadOnlyCollection<string>(this._words);
		}
