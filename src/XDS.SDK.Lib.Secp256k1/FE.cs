...
namespace XDS.SDK.Lib.Secp256k1
{
	...
	readonly struct FE : IEquatable<FE>
	{
		...
		{
			this.n0 = a;
			this.n1 = this.n2 = this.n3 = this.n4 = this.n5 = this.n6 = this.n7 = this.n8 = this.n9 = 0;
			this.magnitude = 1;
		...
		{
			this.n0 = (uint)bytes[31] | ((uint)bytes[30] << 8) | ((uint)bytes[29] << 16) | ((uint)(bytes[28] & 0x3) << 24);
			this.n1 = (uint)((bytes[28] >> 2) & 0x3f) | ((uint)bytes[27] << 6) | ((uint)bytes[26] << 14) | ((uint)(bytes[25] & 0xf) << 22);
			this.n2 = (uint)((bytes[25] >> 4) & 0xf) | ((uint)bytes[24] << 4) | ((uint)bytes[23] << 12) | ((uint)(bytes[22] & 0x3f) << 20);
			this.n3 = (uint)((bytes[22] >> 6) & 0x3) | ((uint)bytes[21] << 2) | ((uint)bytes[20] << 10) | ((uint)bytes[19] << 18);
			this.n4 = (uint)bytes[18] | ((uint)bytes[17] << 8) | ((uint)bytes[16] << 16) | ((uint)(bytes[15] & 0x3) << 24);
			this.n5 = (uint)((bytes[15] >> 2) & 0x3f) | ((uint)bytes[14] << 6) | ((uint)bytes[13] << 14) | ((uint)(bytes[12] & 0xf) << 22);
			this.n6 = (uint)((bytes[12] >> 4) & 0xf) | ((uint)bytes[11] << 4) | ((uint)bytes[10] << 12) | ((uint)(bytes[9] & 0x3f) << 20);
			this.n7 = (uint)((bytes[9] >> 6) & 0x3) | ((uint)bytes[8] << 2) | ((uint)bytes[7] << 10) | ((uint)bytes[6] << 18);
			this.n8 = (uint)bytes[5] | ((uint)bytes[4] << 8) | ((uint)bytes[3] << 16) | ((uint)(bytes[2] & 0x3) << 24);
			this.n9 = (uint)((bytes[2] >> 2) & 0x3f) | ((uint)bytes[1] << 6) | ((uint)bytes[0] << 14);
			if (this.n9 == 0x3FFFFFUL && (this.n8 & this.n7 & this.n6 & this.n5 & this.n4 & this.n3 & this.n2) == 0x3FFFFFFUL && (this.n1 + 0x40UL + ((this.n0 + 0x3D1UL) >> 26)) > 0x3FFFFFFUL)
			{
				if (throws)
	...
	(((uint)d7) >> 10), 1, true);
		...
		public readonly bool IsZero
		{
			...
			get
			{
				VERIFY_CHECK(this.normalized);
				VERIFY();
				return (this.n0 | this.n1 | this.n2 | this.n3 | this.n4 | this.n5 | this.n6 | this.n7 | this.n8 | this.n9) == 0;
			}
		}
		...
		public readonly FE Negate(int m)
		{
			...
			VERIFY();
			var result = new FE(
				(uint)(0x3FFFC2FUL * 2 * (uint)(m + 1) - this.n0),
				(uint)(0x3FFFFBFUL * 2 * (uint)(m + 1) - this.n1),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n2),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n3),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n4),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n5),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n6),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n7),
				(uint)(0x3FFFFFFUL * 2 * (uint)(m + 1) - this.n8),
				(uint)(0x03FFFFFUL * 2 * (uint)(m + 1) - this.n9),
				m + 1, false
				);
			result.VERIFY();
			return result;
		...
		public readonly void WriteToSpan(Span<byte> r)
		{
			this.VERIFY();
			VERIFY_CHECK(this.normalized);
			r[0] = (byte)((this.n9 >> 14) & 0xff);
			r[1] = (byte)((this.n9 >> 6) & 0xff);
			r[2] = (byte)(((this.n9 & 0x3F) << 2) | ((this.n8 >> 24) & 0x3));
			r[3] = (byte)((this.n8 >> 16) & 0xff);
			r[4] = (byte)((this.n8 >> 8) & 0xff);
			r[5] = (byte)(this.n8 & 0xff);
			r[6] = (byte)((this.n7 >> 18) & 0xff);
			r[7] = (byte)((this.n7 >> 10) & 0xff);
			r[8] = (byte)((this.n7 >> 2) & 0xff);
			r[9] = (byte)(((this.n7 & 0x3) << 6) | ((this.n6 >> 20) & 0x3f));
			r[10] = (byte)((this.n6 >> 12) & 0xff);
			r[11] = (byte)((this.n6 >> 4) & 0xff);
			r[12] = (byte)(((this.n6 & 0xf) << 4) | ((this.n5 >> 22) & 0xf));
			r[13] = (byte)((this.n5 >> 14) & 0xff);
			r[14] = (byte)((this.n5 >> 6) & 0xff);
			r[15] = (byte)(((this.n5 & 0x3f) << 2) | ((this.n4 >> 24) & 0x3));
			r[16] = (byte)((this.n4 >> 16) & 0xff);
			r[17] = (byte)((this.n4 >> 8) & 0xff);
			r[18] = (byte)(this.n4 & 0xff);
			r[19] = (byte)((this.n3 >> 18) & 0xff);
			r[20] = (byte)((this.n3 >> 10) & 0xff);
			r[21] = (byte)((this.n3 >> 2) & 0xff);
			r[22] = (byte)(((this.n3 & 0x3) << 6) | ((this.n2 >> 20) & 0x3f));
			r[23] = (byte)((this.n2 >> 12) & 0xff);
			r[24] = (byte)((this.n2 >> 4) & 0xff);
			r[25] = (byte)(((this.n2 & 0xf) << 4) | ((this.n1 >> 22) & 0xf));
			r[26] = (byte)((this.n1 >> 14) & 0xff);
			r[27] = (byte)((this.n1 >> 6) & 0xff);
			r[28] = (byte)(((this.n1 & 0x3f) << 2) | ((this.n0 >> 24) & 0x3));
			r[29] = (byte)((this.n0 >> 16) & 0xff);
			r[30] = (byte)((this.n0 >> 8) & 0xff);
			r[31] = (byte)(this.n0 & 0xff);
		}

		[Conditional("SECP256K1_VERIFY")]
		private readonly void VERIFY()
		{
			int m = this.normalized ? 1 : 2 * this.magnitude, r = 1;
			r &= (this.n0 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n1 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n2 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n3 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n4 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n5 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n6 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n7 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n8 <= 0x3FFFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.n9 <= 0x03FFFFFUL * (uint)m) ? 1 : 0;
			r &= (this.magnitude >= 0 ? 1 : 0);
			r &= (this.magnitude <= 32 ? 1 : 0);
			if (this.normalized)
			{
				r &= (this.magnitude <= 1 ? 1 : 0);
				if (r != 0 && (this.n9 == 0x03FFFFFUL))
				{
					uint mid = this.n8 & this.n7 & this.n6 & this.n5 & this.n4 & this.n3 & this.n2;
					if (mid == 0x3FFFFFFUL)
					{
						r &= ((this.n1 + 0x40UL + ((this.n0 + 0x3D1UL) >> 26)) <= 0x3FFFFFFUL) ? 1 : 0;
					}
				}
			}
			VERIFY_CHECK(r == 1);
		...
		public readonly override int GetHashCode()
		{
			...
			{
				int hash = 17;
				hash = hash * 23 + this.n0.GetHashCode();
				hash = hash * 23 + this.n1.GetHashCode();
				hash = hash * 23 + this.n2.GetHashCode();
				hash = hash * 23 + this.n3.GetHashCode();
				hash = hash * 23 + this.n4.GetHashCode();
				hash = hash * 23 + this.n5.GetHashCode();
				hash = hash * 23 + this.n6.GetHashCode();
				hash = hash * 23 + this.n7.GetHashCode();
				hash = hash * 23 + this.n8.GetHashCode();
				hash = hash * 23 + this.n9.GetHashCode();
				return hash;
			}
		}
		...
		{
			var normalizedStr = this.normalized ? "1" : "0";
			return $"secp256k1_fe {varName} = {{ 0x{this.n0.ToString("X8")}UL, 0x{this.n1.ToString("X8")}UL, 0x{this.n2.ToString("X8")}UL, 0x{this.n3.ToString("X8")}UL, 0x{this.n4.ToString("X8")}UL, 0x{this.n5.ToString("X8")}UL, 0x{this.n6.ToString("X8")}UL, 0x{this.n7.ToString("X8")}UL, 0x{this.n8.ToString("X8")}UL, 0x{this.n9.ToString("X8")}UL, {this.magnitude}, {normalizedStr} }};";
		}
	}
}
#nullable restore
