 ...
 */
	...
	0x9cf04975u, 0x12f58995u, 0xc1396c28u, 0x719501eeu
		...
		{
			return new GE(this.x * beta, this.y, this.infinity);
		}
		...
		{
			return new GE(this.x, this.y.Normalize(), this.infinity);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public readonly GE NormalizeYVariable()
		{
			return new GE(this.x, this.y.NormalizeVariable(), this.infinity);
		}

		[MethodImpl(MethodImplOptions.NoOptimization)]
		public readonly GE Negate()
		{
			var ry = this.y.NormalizeWeak();
			ry = ry.Negate(1);
			return new GE(this.x, ry, this.infinity);
		}
		...
		{
			return new GEJ(this.x, this.y, new FE(1), this.infinity);
		}

		public readonly string ToC(string varName)
		{
			StringBuilder b = new StringBuilder();
			b.AppendLine(this.x.ToC($"{varName}x"));
			b.AppendLine(this.y.ToC($"{varName}y"));
			var infinitystr = this.infinity ? 1 : 0;
		...
		{
			VERIFY_CHECK(!this.infinity);
			return new GEStorage(this.x, this.y);
		}
