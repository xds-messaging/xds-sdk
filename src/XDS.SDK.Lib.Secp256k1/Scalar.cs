...
namespace XDS.SDK.Lib.Secp256k1
{
	...
	readonly struct Scalar : IEquatable<Scalar>
	{
		...
		Scalar(uint value)
		{
			this.d0 = this.d1 = this.d2 = this.d3 = this.d4 = this.d5 = this.d6 = this.d7 = 0;
			this.d0 = value;
		}
#if SECP256K1_LIB
		public
		...
		{
			this.d0 = (uint)b32[31] | (uint)b32[30] << 8 | (uint)b32[29] << 16 | (uint)b32[28] << 24;
			this.d1 = (uint)b32[27] | (uint)b32[26] << 8 | (uint)b32[25] << 16 | (uint)b32[24] << 24;
			this.d2 = (uint)b32[23] | (uint)b32[22] << 8 | (uint)b32[21] << 16 | (uint)b32[20] << 24;
			this.d3 = (uint)b32[19] | (uint)b32[18] << 8 | (uint)b32[17] << 16 | (uint)b32[16] << 24;
			this.d4 = (uint)b32[15] | (uint)b32[14] << 8 | (uint)b32[13] << 16 | (uint)b32[12] << 24;
			this.d5 = (uint)b32[11] | (uint)b32[10] << 8 | (uint)b32[9] << 16 | (uint)b32[8] << 24;
			this.d6 = (uint)b32[7] | (uint)b32[6] << 8 | (uint)b32[5] << 16 | (uint)b32[4] << 24;
			this.d7 = (uint)b32[3] | (uint)b32[2] << 8 | (uint)b32[1] << 16 | (uint)b32[0] << 24;
			overflow = CheckOverflow();
			// Reduce(ref d0, ref d1, ref d2, ref d3, ref d4, ref d5, ref d6, ref d7, overflow);
			ulong t;
			VERIFY_CHECK(overflow == 0 || overflow == 1);
			t = (ulong)this.d0 + (uint)overflow * SECP256K1_N_C_0;
			this.d0 = (uint)t; t >>= 32;
			t += (ulong)this.d1 + (uint)overflow * SECP256K1_N_C_1;
			this.d1 = (uint)t; t >>= 32;
			t += (ulong)this.d2 + (uint)overflow * SECP256K1_N_C_2;
			this.d2 = (uint)t; t >>= 32;
			t += (ulong)this.d3 + (uint)overflow * SECP256K1_N_C_3;
			this.d3 = (uint)t; t >>= 32;
			t += (ulong)this.d4 + (uint)overflow * SECP256K1_N_C_4;
			this.d4 = (uint)t; t >>= 32;
			t += (ulong)this.d5;
			this.d5 = (uint)t; t >>= 32;
			t += (ulong)this.d6;
     ...
     * if we are flag = 1, mask = 11...11 and this is identical to secp256k1_scalar_negate */
			...
			uint nonzero = 0xFFFFFFFFU * (this.IsZero ? 0U : 1);
		...
		internal readonly int CheckOverflow()
		{
			int yes = 0;
			int no = 0;
			no |= (this.d7 < SECP256K1_N_7 ? 1 : 0);
			no |= (this.d6 < SECP256K1_N_6 ? 1 : 0);
			no |= (this.d5 < SECP256K1_N_5 ? 1 : 0);
			no |= (this.d4 < SECP256K1_N_4 ? 1 : 0);
			yes |= (this.d4 > SECP256K1_N_4 ? 1 : 0) & ~no;
			no |= (this.d3 < SECP256K1_N_3 ? 1 : 0) & ~yes;
			yes |= (this.d3 > SECP256K1_N_3 ? 1 : 0) & ~no;
			no |= (this.d2 < SECP256K1_N_2 ? 1 : 0) & ~yes;
			yes |= (this.d2 > SECP256K1_N_2 ? 1 : 0) & ~no;
			no |= (this.d1 < SECP256K1_N_1 ? 1 : 0) & ~yes;
			yes |= (this.d1 > SECP256K1_N_1 ? 1 : 0) & ~no;
			yes |= (this.d0 >= SECP256K1_N_0 ? 1 : 0) & ~no;
			return yes;
		}
		...
		{
			bin[0] = (byte)(this.d7 >> 24); bin[1] = (byte)(this.d7 >> 16); bin[2] = (byte)(this.d7 >> 8); bin[3] = (byte)this.d7;
			bin[4] = (byte)(this.d6 >> 24); bin[5] = (byte)(this.d6 >> 16); bin[6] = (byte)(this.d6 >> 8); bin[7] = (byte)this.d6;
			bin[8] = (byte)(this.d5 >> 24); bin[9] = (byte)(this.d5 >> 16); bin[10] = (byte)(this.d5 >> 8); bin[11] = (byte)this.d5;
			bin[12] = (byte)(this.d4 >> 24); bin[13] = (byte)(this.d4 >> 16); bin[14] = (byte)(this.d4 >> 8); bin[15] = (byte)this.d4;
			bin[16] = (byte)(this.d3 >> 24); bin[17] = (byte)(this.d3 >> 16); bin[18] = (byte)(this.d3 >> 8); bin[19] = (byte)this.d3;
			bin[20] = (byte)(this.d2 >> 24); bin[21] = (byte)(this.d2 >> 16); bin[22] = (byte)(this.d2 >> 8); bin[23] = (byte)this.d2;
			bin[24] = (byte)(this.d1 >> 24); bin[25] = (byte)(this.d1 >> 16); bin[26] = (byte)(this.d1 >> 8); bin[27] = (byte)this.d1;
			bin[28] = (byte)(this.d0 >> 24); bin[29] = (byte)(this.d0 >> 16); bin[30] = (byte)(this.d0 >> 8); bin[31] = (byte)this.d0;
		}
		...
		{
			r1 = new Scalar(this.d0, this.d1, this.d2, this.d3, 0, 0, 0, 0);
			r2 = new Scalar(this.d4, this.d5, this.d6, this.d7, 0, 0, 0, 0);
		}
...
*/
		...
		public bool IsHigh
		{
			get
			{
				int yes = 0;
				int no = 0;
				no |= (this.d7 < SECP256K1_N_H_7 ? 1 : 0);
				yes |= (this.d7 > SECP256K1_N_H_7 ? 1 : 0) & ~no;
				no |= (this.d6 < SECP256K1_N_H_6 ? 1 : 0) & ~yes; /* No need for a > check. */
				no |= (this.d5 < SECP256K1_N_H_5 ? 1 : 0) & ~yes; /* No need for a > check. */
				no |= (this.d4 < SECP256K1_N_H_4 ? 1 : 0) & ~yes; /* No need for a > check. */
				no |= (this.d3 < SECP256K1_N_H_3 ? 1 : 0) & ~yes;
				yes |= (this.d3 > SECP256K1_N_H_3 ? 1 : 0) & ~no;
				no |= (this.d2 < SECP256K1_N_H_2 ? 1 : 0) & ~yes;
				yes |= (this.d2 > SECP256K1_N_H_2 ? 1 : 0) & ~no;
				no |= (this.d1 < SECP256K1_N_H_1 ? 1 : 0) & ~yes;
				yes |= (this.d1 > SECP256K1_N_H_1 ? 1 : 0) & ~no;
				yes |= (this.d0 > SECP256K1_N_H_0 ? 1 : 0) & ~no;
				return yes != 0;
			}
		}
		...
		public readonly bool IsZero
		{
			...
			get
			{
				return (this.d0 | this.d1 | this.d2 | this.d3 | this.d4 | this.d5 | this.d6 | this.d7) == 0;
			}
		}
		public readonly bool IsOne
		{
			...
			get
			{
				return ((this.d0 ^ 1) | this.d1 | this.d2 | this.d3 | this.d4 | this.d5 | this.d6 | this.d7) == 0;
			}
		}
		...
		public readonly int ShrInt(int n, out Scalar ret)
		{
			VERIFY_CHECK(n > 0);
			VERIFY_CHECK(n < 16);
			var v = (int)(this.d0 & ((1 << n) - 1));
			ret = new Scalar
			(
				(this.d0 >> n) + (this.d1 << (32 - n)),
				(this.d1 >> n) + (this.d2 << (32 - n)),
				(this.d2 >> n) + (this.d3 << (32 - n)),
				(this.d3 >> n) + (this.d4 << (32 - n)),
				(this.d4 >> n) + (this.d5 << (32 - n)),
				(this.d5 >> n) + (this.d6 << (32 - n)),
				(this.d6 >> n) + (this.d7 << (32 - n)),
				(this.d7 >> n)
			);
			return v;
		}
		...
		public readonly override int GetHashCode()
		{
			...
			{
				int hash = 17;
				hash = hash * 23 + this.d0.GetHashCode();
		...
		{
			return $"secp256k1_scalar {varname} = {{ 0x{this.d0.ToString("X8")}UL, 0x{this.d1.ToString("X8")}UL, 0x{this.d2.ToString("X8")}UL, 0x{this.d3.ToString("X8")}UL, 0x{this.d4.ToString("X8")}UL, 0x{this.d5.ToString("X8")}UL, 0x{this.d6.ToString("X8")}UL, 0x{this.d7.ToString("X8")}UL }}";
		}
