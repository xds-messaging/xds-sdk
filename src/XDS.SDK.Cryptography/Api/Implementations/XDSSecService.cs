...
{
    public class XDSSecService : IXDSSecService
    {
        XDSSecAPIInternal _internal;
        IPlatform _platform;
        bool _log = false;

        public void Init(IPlatform platform, string name = "XDSSecService Default Instance")
        {
            if (this._platform != null)
                throw new InvalidOperationException("An instance of IPlatform has already been supplied.");
            this._platform = platform;
            this.Name = name;
            this._internal = new XDSSecAPIInternal(this._platform);
        ...
        public Response<ECKeyPair> GenerateCurve25519KeyPairExact(byte[] privateKey)
        {
            ...
            try
            {
                ...
                var keyPair = new ECKeyPair { PrivateKey = privateKey, PublicKey = publicKey };
        ...
        {
            return this._platform.ComputeSHA512(data);
        }
    }
}